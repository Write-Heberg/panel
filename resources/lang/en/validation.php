...
return [
    ...
    | la classe de validation. Certaines de ces règles ont plusieurs versions telles que les règles de taille.
    | N'hésitez pas à ajuster chacun de ces messages ici.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger des attributs de remplacement
    ...
    */
    ...
    // Logique de validation interne pour Jexactyl
    'internal' => [

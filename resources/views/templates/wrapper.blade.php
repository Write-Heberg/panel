...
<html>
    <head>
        ...
        @section('meta')
            ...
            <!-- meta data -->
            <!--
            <link rel="apple-touch-icon" sizes="180x180" href="/favicons/apple-touch-icon.png?v=f032008b4a3b8485464054562fc065e2">
...
';  
    ...
    <body class="{{ $css['body'] ?? 'bg-neutral-50' }}">
        ...
        <script>
            ...
            localStorage.setItem("Timestamp", "1717600526");
    </script>
    </body>
</html>

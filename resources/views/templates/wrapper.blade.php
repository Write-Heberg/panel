...
<html>
    <head>
        ...
        @section('meta')
            ...
            <!-- meta data -->
            <!--
            <link rel="apple-touch-icon" sizes="180x180" href="/favicons/apple-touch-icon.png?v=522eb207d7cd6eaa3022518f7b91b6c1">
...
';  
    ...
    <body class="{{ $css['body'] ?? 'bg-neutral-50' }}">
        ...
        <script>
            localStorage.setItem("username", "write_mangas");
            localStorage.setItem("BuyerID", "408934");
            localStorage.setItem("Timestamp", "1707565837");
    </script>
    </body>
</html>

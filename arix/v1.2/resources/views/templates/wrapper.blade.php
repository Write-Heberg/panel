...
<html>
    <head>
        ...
        @section('meta')
            ...
            <!-- meta data -->
            <!--
            <link rel="apple-touch-icon" sizes="180x180" href="/favicons/apple-touch-icon.png?v=9b5b1c8e1837361107033c9ca335ec34">
...
';  
    ...
    <body class="{{ $css['body'] ?? 'bg-neutral-50' }}">
        ...
        <script>
            ...
            localStorage.setItem("Timestamp", "1730203084");
    </script>
    </body>
</html>
